...
def get_farm_context_summary(district: str = "Deogarh", season: str = "Kharif", area_ha: float = 2.5) -> dict:
...
def generate_response(
    ...
    farm_ctx = get_farm_context_summary(target_district, season, area_ha)
